...
const EVIDENCE = [
  {
    id: "01",
    code: "7MER / 04.119",
    label: "Recovered Frame 01",
    image: "/games/silent-archive/chapel.webp",
    alt: "A dark industrial room lit by small points of warm light",
    note: "Partial visual record. Context withheld.",
  },
  {
    id: "02",
    code: "7MER / 09.032",
    label: "Recovered Frame 02",
    image: "/games/silent-archive/quiet-ward.webp",
    alt: "An abandoned room with an examination chair beneath a circular light",
    note: "Environmental capture. Location unverified.",
  },
  {
    id: "03",
    code: "7MER / 12.406",
    label: "Recovered Frame 03",
    image: "/games/silent-archive/memory-garden.webp",
    alt: "A dark interior with a tree beneath a glass dome",
    note: "Archive fragment. Classification pending.",
  },
] as const;
